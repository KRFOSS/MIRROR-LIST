...
export default function UbuntuArchiveMirrorTable() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        // API 주소 변경
        const response = await fetch("/api/mirrorlist/ubuntu/apt")
        if (!response.ok) {
  ...
  return (
    <div className="p-4 sm:p-6 font-sans w-full">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-2xl font-bold mb-2">Ubuntu APT 미러 목록</h1>
