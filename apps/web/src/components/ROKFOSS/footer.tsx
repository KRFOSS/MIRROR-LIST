    ...
    <footer>
      <div className="container footer-content">
        ...
        <div className="footer-column">
          ...
          <ul className="footer-links">
            <li>
              <a href="mailto:krfoss@krfoss.org">공식메일로 문의하기</a>
            </li>
            <li>
              <a href="https://http.krfoss.org">분산미러 이용하기</a>
            </li>
            <li>
              <a href="https://discord.gg/XqPQfud5fc">커뮤니티에 가입하기</a>
            </li>
            <li>
              <a href="https://kali.krfoss.org">칼리 리눅스 한국어 문서</a>
            </li>
            <li>
              <a href="https://docs.krfoss.org">ROKFOSS Docs(문서)</a>
            </li>
            <li>
              <a href="https://news.krfoss.org">ROKFOSS 프로젝트 뉴스룸</a>
            </li>
            <li>
              <a href="https://dalcom.krfoss.org">ROKFOSS 허니팟 공개 DB</a>
            </li>
            <li>
              <a href="https://status.krfoss.or.kr/status/krfoss">
                ROKFOSS 및 참여 미러 서비스 상태
              </a>
            </li>
          </ul>
        </div>
