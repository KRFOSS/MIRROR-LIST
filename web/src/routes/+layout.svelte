		...
		<div class="logo">
			<a href="/">
				<img
					...
					loading="eager"
					decoding="async"
					src="https://http.krfoss.org/.web/ROKFOSS.png"
					alt="ROKFOSS 로고"
				/>
			</a>
		</div>
		<nav class="nav-links">
			<a href="https://chat.krfoss.org/" class="menu-item">참여하기</a>
			<a href="https://news.krfoss.org" class="menu-item">ROKFOSS 뉴스룸</a>
			<a href="#" class="menu-item" onclick={() => location.reload()}>새로고침</a>
		</nav>
	</div>
</header>
	...
	<div class="footer-content container">
		<div class="footer-column">
			...
			<ul class="footer-links">
				<li>
					<img
						src="https://cdn.eliv.kr/eliv/Assets/Images/Logo/BLACK.svg"
						alt="ELIV 로고"
						class="eliv-logo"
					/>
					<svg
            ...
            "
					...
					<img
						src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/2025-03-04%2012.24.08.jpg-FKLBg1CJteBLvxN4fcMdq57wykPKwq.png"
						alt="tefexia 로고"
						style="
                        max-height:80px;
                        margin-left:1rem;
		...
		<div class="footer-column">
			...
			<ul class="footer-links">
				<li><a href="mailto:krfoss@krfoss.org">공식메일로 문의하기</a></li>
				<li><a href="https://http.krfoss.org">분산미러 이용하기</a></li>
				<li><a href="https://discord.gg/XqPQfud5fc">커뮤니티에 가입하기</a></li>
				<li><a href="https://kali.krfoss.org">칼리 리눅스 한국어 문서</a></li>
				<li><a href="https://docs.krfoss.org">ROKFOSS Docs(문서)</a></li>
				<li><a href="https://news.krfoss.org">ROKFOSS 프로젝트 뉴스룸</a></li>
				<li><a href="https://dalcom.krfoss.org">ROKFOSS 허니팟 공개 DB</a></li>
				<li>
					<a href="https://status.krfoss.or.kr/status/krfoss">ROKFOSS 및 참여 미러 서비스 상태</a>
				</li>
			</ul>
		</div>
	</div>
	<div class="copyright container">
		<p>© 2025 ROKFOSS. 모든 권리 보유 | ROKFOSS PROJECT</p>
	</div>
</footer>
